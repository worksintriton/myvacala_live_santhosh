...
import com.triton.myvacala.adapter.VehicleBrandExpandableListOldUserAdapter;
...
public class VehicleBrandListOldUserActivity extends AppCompatActivity implements View.OnClickListener, VehicleIdListener,VehicleBrandExpandableListOldUserAdapter.ExpandListChildViewListener {
    ...
    private String TAG = "VehicleBrandListOldUserActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vehicle_brand_olduser_list);
        ...
        if (new ConnectionDetector(VehicleBrandListOldUserActivity.this).isNetworkAvailable(VehicleBrandListOldUserActivity.this)) {
    ...
    public void callDirections(String tag){
        Intent intent = new Intent(VehicleBrandListOldUserActivity.this,DashboardActivity.class);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.img_search:
                ...
                KeyboardUtils.hideKeyboard(VehicleBrandListOldUserActivity.this);
                break;
    ...
    private void setView(List<VehicleBrandListResponse.DataBean> expandableListTitle){
        ...
        VehicleBrandExpandableListOldUserAdapter vehicleBrandExpandableListAdapter = new VehicleBrandExpandableListOldUserAdapter(this, expandableListTitle, stringListHashMap,vehicle_name_list,
                VehicleBrandListOldUserActivity.this,vehicleTypeGetList,this,vehicletype_Name);

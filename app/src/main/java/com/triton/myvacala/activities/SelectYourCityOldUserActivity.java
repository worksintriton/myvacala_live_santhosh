...
import com.triton.myvacala.adapter.CityListOldUserAdapter;
...
public class SelectYourCityOldUserActivity extends AppCompatActivity {
    ...
    CityListOldUserAdapter cityListAdapter;
    private SharedPreferences preferences;
    String TAG = "SelectYourCityOldUserActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (new ConnectionDetector(SelectYourCityOldUserActivity.this).isNetworkAvailable(SelectYourCityOldUserActivity.this)) {
    ...
    public void callDirections(String tag){
        Intent intent = new Intent(SelectYourCityOldUserActivity.this,DashboardActivity.class);
    ...
    private void setView() {
        ...
        cityListAdapter = new CityListOldUserAdapter(getApplicationContext(), getServiceListResponseList, rv_citylist);

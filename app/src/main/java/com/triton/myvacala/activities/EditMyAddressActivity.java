...
public class EditMyAddressActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras != null) {
           ...
           if(latlng != null && !latlng.equalsIgnoreCase("null")) {
            ...
            Log.w(TAG," lat "+latitude+" "+" lon :"+longtitude+" flatno : "+flatno+" nearbylandmark : "+nearbylandmark+ "  locationnickname : "+locationnickname+" LocationType : "+LocationType);
    ...
    public void callDirections(String tag){
        Intent intent = new Intent(EditMyAddressActivity.this,DashboardActivity.class);
    ...
    private void gotoEditmapsPage() {
        Intent i = new Intent(EditMyAddressActivity.this, EditMapsActivity.class);
        i.putExtra("id",id);
            ...
            public void onResponse(@NotNull Call<LocationEditResponse> call, @NotNull Response<LocationEditResponse> response) {
                ...
                if (response.body() != null) {
                    ...
                    if(response.body().getCode() == 200){
                        ...
                        Intent i = new Intent(EditMyAddressActivity.this,LocationListActivity.class);

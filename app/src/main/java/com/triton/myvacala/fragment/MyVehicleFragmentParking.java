...
import com.triton.myvacala.activities.parking.vehicle.ParkingPopularVehicleListActivity;
import com.triton.myvacala.adapter.ParkingVehicleListAdapter;
...
public class MyVehicleFragmentParking extends Fragment implements View.OnClickListener, VehicleStatusChangeListener {
    ...
    private String TAG ="MyVehicleFragmentParking";
    ...
    ParkingVehicleListAdapter parkingVehicleListAdapter;
    ...
    private String selectedVehicleId,selectedVehicleType,masterserviceid,fromactivity;
    ...
    public MyVehicleFragmentParking() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        selectedVehicleId = APIClient.selectedVehicleTypeId;
        ...
        if(fromactivity != null){
            if(fromactivity.equalsIgnoreCase("DasboardParkingActivity")){
             if(selectedVehicleType.equalsIgnoreCase("Four Wheeler")){
                   toggleButton.setChecked(true);
                     ...
                     if (new ConnectionDetector(getActivity()).isNetworkAvailable(Objects.requireNonNull(getActivity()))) {
                         ...
                         vehicleListsResponseCall(selectedVehicleId);
...
*/
        ...
        toggleButton.setOnCheckedChangeListener((buttonView, isChecked) -> Log.w(TAG,"setOnCheckedChangeListener"+buttonView.getText().toString()+""+""+isChecked));
        ...
        iv_addvehicle.setOnClickListener(v -> {
            Intent intent = new Intent(getActivity(), ParkingPopularVehicleListActivity.class);
        ...
        swipeRefreshLayout.setOnRefreshListener(() -> {
            ...
            if(getActivity() != null) {
                if (new ConnectionDetector(getActivity()).isNetworkAvailable(getActivity())) {
                    vehicleListsResponseCall(vehicletype_id);
                }
            }
    ...
    public void vehicleListsResponseCall(String vehicletype_id){
        avi_indicator.setVisibility(View.VISIBLE);
        avi_indicator.smoothToShow();
        //Creating an object of our api interface
        RestApiInterface apiInterface = APIClient.getClient().create(RestApiInterface.class);
    ...
    private void setView() {
        ...
        parkingVehicleListAdapter = new ParkingVehicleListAdapter(mContext,vehicleListsResponseList , rv_vehiclelists,this);
        rv_vehiclelists.setAdapter(parkingVehicleListAdapter);

        parkingVehicleListAdapter.setOnLoadMoreListener(() -> {
            ...
            public void onResponse(@NotNull Call<VehicleStatusChangeResponse> call, @NotNull Response<VehicleStatusChangeResponse> response) {
                ...
                if (response.body() != null) {
                    if(response.body().getCode() == 200){
                        ...
                        vehicleListsResponseCall(vehicletypeId);

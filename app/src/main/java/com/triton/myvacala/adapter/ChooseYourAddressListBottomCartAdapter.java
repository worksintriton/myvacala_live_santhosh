...
public class ChooseYourAddressListBottomCartAdapter extends  RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private static final int TYPE_ONE = 1;
    private static final int TYPE_LOADING = 5;
    private  String TAG = "ChooseYourAddressListBottomCartAdapter";
  ...
  private LocationIdListener locationIdListener;





    public ChooseYourAddressListBottomCartAdapter(Context context, ArrayList<GetCardDetailsResponse.LocationAvailableBean> locationAvailableBeanArrayList, RecyclerView inbox_list, String fromactivity,LocationIdListener locationIdListener) {
        this.locationAvailableBeanArrayList = locationAvailableBeanArrayList;
        this.context = context;
        this.fromactivity = fromactivity;
        this.locationIdListener = locationIdListener;
            ...
            dialogButtonApprove.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if(locationid != null && !locationid.isEmpty()) {
                        locationIdListener.onItemCheck(locationid);
                    }
                    dialog.dismiss();

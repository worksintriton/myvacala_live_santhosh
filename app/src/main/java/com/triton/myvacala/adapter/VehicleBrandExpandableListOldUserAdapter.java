...
import com.triton.myvacala.activities.VehicleBrandListOldUserActivity;
...
public class VehicleBrandExpandableListOldUserAdapter extends BaseExpandableListAdapter   {

    private String TAG ="VehicleBrandExpandableListOldUserAdapter";
   ...
   // private VehicleBrandListResponse.DataBean.VehicleNameListBean.VehicleModelBean vehicleModelBean;
    ...
    public VehicleBrandExpandableListOldUserAdapter(Context context, List<VehicleBrandListResponse.DataBean> expandableListTitle,
                                                    ...
                                                    VehicleBrandListOldUserActivity vehicleBrandListActivity, List<String> vehicleTypeGetList, ExpandListChildViewListener expandListChildViewListener, String vehicletype_Name) {

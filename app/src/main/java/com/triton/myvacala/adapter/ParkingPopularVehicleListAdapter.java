...
public class ParkingPopularVehicleListAdapter extends  RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private  String TAG = "ParkingPopularVehicleListAdapter";
    ...
    public ParkingPopularVehicleListAdapter(Context context, List<PopularVehicleListResponse.DataBean> popularVehicleListResponseList, RecyclerView inbox_list ) {

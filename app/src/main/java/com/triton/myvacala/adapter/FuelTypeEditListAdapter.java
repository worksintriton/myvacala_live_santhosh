...
public class FuelTypeEditListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private static final int TYPE_ONE = 1;
    private static final int TYPE_LOADING = 5;
    private String TAG = "FuelTypeEditListAdapter";
    ...
    public FuelTypeEditListAdapter(Context context, List<VehicleDetailsResponse.DataBean.FuelTypeBean> fuelTypeBeanList, RecyclerView inbox_list, VehicleFuelTypeListener vehcilFuelTypeListener, String fuel_Type_Name) {
    ...
    private void initLayoutOne(ViewHolderOne holder, final int position) {
        ...
        holder.btn_fuel_type.setBackgroundResource(R.drawable.tags_rounded_corners_withoutcorner);
        Log.w(TAG, "position--->" + position);
        Log.w(TAG, "List If------->" + new Gson().toJson(fuelTypeBeanList));
        if (fuelTypeBeanList.get(position).isSelected()) {
            ...
            holder.btn_fuel_type.setBackgroundColor(Color.parseColor(currentItem.getBackground_Color()));
            holder.btn_fuel_type.setBackgroundResource(R.drawable.tags_rounded_corners_withoutcorner);
            //  holder.btn_fuel_type.setBackground(ContextCompat.getDrawable(context,R.drawable.tags_rounded_corners));
            GradientDrawable gd = (GradientDrawable) holder.btn_fuel_type.getBackground();
            gd.setColor(Color.parseColor(currentItem.getBackground_Color()));
            ...
            // holder.btn_fuel_type.setBackground(ContextCompat.getDrawable(context,R.drawable.tags_rounded_corners_withoutcorner));
            gd.setColor(Color.parseColor(currentItem.getBackground_Color()));
            gd.setCornerRadius(10);
        ...
        holder.btn_fuel_type.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.w(TAG, "isSelected---->" + fuelTypeBeanList.get(position).isSelected());
